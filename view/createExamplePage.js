...
var createExamplePage =function(title: ?string, exampleModule: ExampleModule) 
    ...
    var ExamplePage = React.createClass({
        ...
        getBlock: function(example: Example, i) {
            ...
            (ReactNative: Object).renderComponent = function(element, container) {
                renderComponent = element;
            }

            var result = example.render(null);
            if (result) {
                renderComponent = React.cloneElement(result, {
            ...
            return (
                <UIExplorerBlock key={i} title={example.title} description={example.description}>
                    {renderedComponent}
                </UIExplorerBlock>
            );
        },
